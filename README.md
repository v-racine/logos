...
A RAG-powered research assistant for querying recent preprints in philosophy of science and formal epistemology, grounded in a curated corpus of papers from 2023–2026 that fall outside most general-purpose models' training data.
